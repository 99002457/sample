...
TEST(account,CopyConstructor) {
    ...
    EXPECT_STREQ("chethan",a2.getCustomerName().c_str());
...
TEST(account,DisplayTest) {
    account a1("1001","chethan",5000.0);
    std::string ExpectedOut="1001,chethan,5000\n";
